...
class Aggregator(ABC):
    ...
    def write_logs(self):
        ...
        with open("log_files_1.txt", 'a') as f:
            f.write(f"{global_train_loss} \t {global_train_metric} \t {global_test_loss} \t {global_test_metric}\n")
...
class CentralizedAggregator(Aggregator):
    ...
    def mix(self):
        ...
        local_models = [client.learner for client in self.clients]
        ...
        average_models(local_models, self.global_learner, clients_weights)
